      ...
      <div className="w-full max-w-7xl mx-auto px-4 py-8">
        <div className="flex flex-col lg:flex-row items-center gap-8 mb-16">
          ...
          <div className="w-full lg:w-1/2 space-y-8">
            ...
            <div className="flex items-start gap-4 bg-white bg-opacity-10 p-6 rounded-lg">
              ...
              <div>
                ...
                <p className="text-black">
                  Emergency response time is one hour or less guaranteed. A live
                  person will answer your call, or you can enter a service
                  ticket yourself.
                </p>
              </div>
            </div>
            ...
            <button
              ...
              className="bg-cyan-400 hover:bg-cyan-300 text-black px-8 py-3 rounded-full font-semibold transition duration-300 w-full md:w-auto"
            >
              Book a session
            </button>
          </div>
        ...
        <div className="mb-16 bg-white bg-opacity-5 p-6 rounded-xl">
          <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
            <div>
              <h2 className="text-3xl font-bold mb-6 text-cyan-400">{name}</h2>
            ...
            <div>
              ...
              <p className="text-gray-400">
                ...
                specializes in helping clients discover their true potential and
